...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        apiClient.Name = "Bitmex-1";
        apiClient.ReconnectTimeout = TimeSpan.FromMinutes(10);
        apiClient.ReconnectionHappened.Subscribe(type =>
    ...
    static async Task StartPinging(BitmexWebsocketClient client)
    {
        await Task.Delay(TimeSpan.FromSeconds(30));
        client.Send(new PingRequest());
    }

    static void SendSubscriptionRequests(BitmexWebsocketClient client)
    {
        client.Send(new PingRequest());
    ...
    static void SubscribeToStreams(BitmexWebsocketClient client)
    {
